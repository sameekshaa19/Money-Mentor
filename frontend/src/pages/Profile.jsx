...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    if (userStr) {
      ...
      setUserEmail(user.email || 'guest@celestial.xyz');
            ...
            <div className="flex flex-col md:flex-row gap-10 items-start relative z-10">
              ...
              <div className="flex-1 w-full">
                <div className="flex justify-between items-center mb-8 border-b border-[#22262f] pb-4">
                  ...
                  <button onClick={() => isEditing ? handleSave() : setIsEditing(true)} className="px-5 py-2 rounded-xl text-xs font-label font-bold tracking-widest uppercase transition-all border border-[#30363d] text-[#a9abb3] hover:text-[#c799ff] hover:border-[#c799ff]/40 cursor-pointer">
